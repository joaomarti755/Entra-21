...
namespace Entra21.BancoDeDados01.Ado.Net.Services
{
    internal class PersonagemService : IPersonagemService
    {
        ...
        {
            // Conectar no banco de dados e difinido a query que será execuada
            var conexao = new Conexao().Conectar();
            var comando = conexao.CreateCommand();
            comando.CommandText =
...
INNER JOIN editoras AS e ON(p.id_editoras = e.id)";
            ...
            // Criando lista de personagens para armazenar os registros
            ...
            for (int i = 0; i < tabelaEmMemoria.Rows.Count; i++)
            {
                ...
                personagem.TipoPersonagem = new TipoPersonagem();
                personagem.TipoPersonagem.Id = Convert.ToInt32(registro["editora_id"]);
                personagem.Editora.Nome = registro["editora_nome"].ToString();
