...
SELECT nome, cpf, rg, data_de_nascimento, idade
	FROM pessoas;
...
SELECT nome, cpf, rg,
	CONCAT(
		...
		YEAR(data_de_nascimento)) AS 'data de nascimento', idade
	FROM pessoas;

SELECT nome, cpf, rg, FORMAT(data_de_nascimento, 'dd/MM/yyyy') AS 'data de nascimento', idade
	FROM pessoas